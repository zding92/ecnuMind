...
CREATE TABLE `competition_main` (
  ...
  `apply_user_studentid` int(11) NOT NULL,
  `comp_type_id` int(5) NOT NULL,
  PRIMARY KEY (`comp_item_id`),
  KEY `FK_competition_user_idx` (`apply_user_studentid`),
  ...
  CONSTRAINT `FK_competition_user` FOREIGN KEY (`apply_user_studentid`) REFERENCES `user_custom` (`user_id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `user_base` VALUES (1,'a','1','1',NULL,'1992-07-21'),(2,'testECNU','cc03e747a6afbbcbf8be7668acfebee5','custom','2015-09-22','2015-09-22');
...
INSERT INTO `user_custom` VALUES (2,'305605080@qq.com','18021051036','你好中国','余粉','资环xxx系','资环学院','资环xxx-2专业','大二','男','你好，我是简介，啦啦','10112110128',11);
...
-- Dump completed on 2015-09-23  0:14:19
