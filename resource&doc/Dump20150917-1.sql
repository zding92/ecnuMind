...
INSERT INTO `competition_main` VALUES (38,21,1),(39,21,1),(40,21,1),(41,21,1),(42,21,1),(43,21,1),(44,21,1);
...
INSERT INTO `tiaozhan_b1` VALUES (42,'fdsaffdsa','fdsa','','fdsa','','','fdsafdas','','fdsa'),(43,'fdas','','fdsa','','fdsa','','','fdas','');
...
INSERT INTO `tiaozhan_b2` VALUES (44,'dfa','','','','','','','',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL);
...
CREATE TABLE `tiaozhan_b3` (
  ...
  `ip1_date` varchar(20) DEFAULT NULL,
  `ip2_date` varchar(20) DEFAULT NULL,
  KEY `FK_1_idx` (`comp_item_id`),
...
CREATE TABLE `tiaozhan_info` (
  ...
  CONSTRAINT `tiaozhan_basic_FK11` FOREIGN KEY (`referee_id`) REFERENCES `tiaozhan_referee` (`referee_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
INSERT INTO `tiaozhan_info` VALUES (42,'test1','A2','B1','B1A',2,'10112110128','null','null','null','null','null',1,123,'2015-09-17',1),(43,'fsa','A1','B1','B1A',3,'10112140253','null','null','null','null','null',1,124,'2015-09-17',1),(44,'ddd','A2','B2','B2B',4,'10112110128','null','null','null','null','null',1,125,'2015-09-17',1);
/*!40000 ALTER TABLE `tiaozhan_info` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `tiaozhan_referee`
--

DROP TABLE IF EXISTS `tiaozhan_referee`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `tiaozhan_referee` (
...
--
-- Dumping data for table `tiaozhan_referee`
--

LOCK TABLES `tiaozhan_referee` WRITE;
/*!40000 ALTER TABLE `tiaozhan_referee` DISABLE KEYS */;
INSERT INTO `tiaozhan_referee` VALUES (2,'fd','男',321,'21','fdsa','fdsa','fds','fsa'),(3,'fds','男',23,'','','','',''),(4,'fds','男',23,'fds','','','','');
/*!40000 ALTER TABLE `tiaozhan_referee` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `tiaozhan_teacher` VALUES (123,'fdsa','男',412,'fdsa','fas','fsa','fs','fdas'),(124,'fdas','男',321,'fdsa','','','',''),(125,'dsa','男',123,'fds','sf','','2311','');
...
-- Dump completed on 2015-09-17 16:36:42
