...
INSERT INTO `competition_main` VALUES (2,'10112110128,10112140125',1);
/*!40000 ALTER TABLE `competition_main` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `competition_partner`
--

DROP TABLE IF EXISTS `competition_partner`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `competition_partner` (
  `comp_item_id` int(11) NOT NULL,
  `user_id` int(11) NOT NULL,
  KEY `FK_1_idx` (`comp_item_id`),
  KEY `FK_2_idx` (`user_id`),
  CONSTRAINT `FK_1` FOREIGN KEY (`comp_item_id`) REFERENCES `competition_main` (`comp_item_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `FK_2` FOREIGN KEY (`user_id`) REFERENCES `user_custom` (`user_id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `competition_partner`
--

LOCK TABLES `competition_partner` WRITE;
/*!40000 ALTER TABLE `competition_partner` DISABLE KEYS */;
/*!40000 ALTER TABLE `competition_partner` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `tiaozhan_info` VALUES (2,'f','A1','B1','B1A','10112110128','10112140125',NULL,NULL,NULL,NULL,1,'2015-09-24',1,'','男',NULL,'','','','','','','男',NULL,'','','','','','','','','','','','','','','','','','','','','','',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'','','','lab','','','',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'','','','');
...
INSERT INTO `user_base` VALUES (1,'a','1','1',NULL,'1992-07-21'),(2,'testECNU','cc03e747a6afbbcbf8be7668acfebee5','custom','2015-09-22','2015-09-22'),(3,'phphhp','64528858aa8a3ba872964006190f7696','custom','2015-09-23','2015-09-23'),(4,'phphhpf','64528858aa8a3ba872964006190f7696','custom','2015-09-24',NULL),(5,'phphhp4','64528858aa8a3ba872964006190f7696','custom','2015-09-24','2015-09-24');
...
-- Dump completed on 2015-09-24 22:28:40
