        ...
        <form id="tiaozhanForm">
                ...
                <div class="info_container_step1">
                    <div class="tiaozhan1_form">
                       ...
                       <!--<div id="dis"></div>--> 
                        ...
                        <h1>作品类型细分：</h1>
                        <div id="B1">
                            <input type="radio" class="B_ratio" name="detailed_type" value="B1A"><h2>机械与控制</h2>
                            <input type="radio" class="B_ratio" name="detailed_type" value="B1B"><h2>信息技术</h2>
                            <input type="radio" class="B_ratio" name="detailed_type" value="B1C"><h2>数理</h2>
                            <input type="radio" class="B_ratio" name="detailed_type" value="B1D"><h2>生命科学</h2>
                            <input type="radio" class="B_ratio" name="detailed_type" value="B1E"><h2>能源化工</h2>
                        </div>
                        <div id="B2">
                            <input type="radio" class="B_ratio" name="detailed_type" value="B2A"><h2>哲学</h2>
                            <input type="radio" class="B_ratio" name="detailed_type" value="B2B"><h2>经济</h2>
                            <input type="radio" class="B_ratio" name="detailed_type" value="B2C"><h2>社会</h2>
                            <input type="radio" class="B_ratio" name="detailed_type" value="B2D"><h2>法律</h2>
                            <input type="radio" class="B_ratio" name="detailed_type" value="B2E"><h2>教育</h2>
                            <input type="radio" class="B_ratio" name="detailed_type" value="B2F"><h2>管理</h2>
                        </div>
                        <div id="B3">
                            <input type="radio" class="B_ratio" name="detailed_type" value="B3A"><h2>机械与控制</h2>
                            <input type="radio" class="B_ratio" name="detailed_type" value="B3B"><h2>信息技术</h2>
                            <input type="radio" class="B_ratio" name="detailed_type" value="B3C"><h2>数理</h2>
                            <input type="radio" class="B_ratio" name="detailed_type" value="B3D"><h2>生命科学</h2>
                            <input type="radio" class="B_ratio" name="detailed_type" value="B3E"><h2>能源化工</h2>
                        </div>
                        <br>
                        <h1>推荐人情况：</h1>
                        
                        <h2>姓名</h2><input type="text" class="teacher_name" name="referee_name" id="referee_name">
                        <br><br>
                        <h2>性别</h2>
                        ...
                        <h2>年龄</h2><input type="text" class="teacher_age" id="referee_age" name="referee_age">
                        <br><br>
                        <h2>工作单位</h2><input type="text" class="teacher_job" id="referee_job" name="referee_job">
                        <br><br>
                        <h2>通讯地址</h2><input type="text" class="teacher_add" id="referee_add" name="referee_add">
                        <br><br>
                        <h2>邮政编码</h2><input type="text" class="teacher_zipcode" id="referee_zipcode" name="referee_zipcode">
                        <br><br>
                        <h2>单位电话</h2><input type="text" class="teacher_workphone" id="referee_workphone" name="referee_workphone">
                        <h2>住宅电话</h2><input type="text" class="teacher_homephone" id="referee_homephone" name="referee_homephone">
                        <br>
            ...
            <div id="step2" style="display: none">
                <div class="tiaozhan2_form">
                    <h2>第一作者：</h2>
                    <br><br>
                    <h1>学号</h1><input type="text" class="author_num" id="author1_num" name="author1_id" placeholder="请输入第一作者学号"><h2 id="author1_num_check" style="color: #ff6a00;font-weight: 500;margin-left: 5px;"></h2>
                    <br><br>
                    ...
                    <h2>合作者1：</h2>
                    <br><br>
                    <h1>学号</h1><input type="text" class="author_num" id="author2_num" name="author2_id" placeholder="请输入合作者1学号"><h2 id="author2_num_check" style="color: #ff6a00;font-weight: 500;margin-left: 5px;"></h2>
                    <br><br>
                    ...
                    <h2>合作者2：</h2>
                    <br><br>
                    <h1>学号</h1><input type="text" class="author_num" id="author3_num" name="author3_id" placeholder="请输入合作者2学号"><h2 id="author3_num_check" style="color: #ff6a00;font-weight: 500;margin-left: 5px;"></h2>
                    <br><br>
                    ...
                    <div id="extra_partner">
                        ...
                        <h2>合作者3：</h2>
                        <br><br>
                        <h1>学号</h1><input type="text" class="author_num" id="author4_num" name="author4_id" placeholder="请输入合作者3学号"><h2 id="author4_num_check" style="color: #ff6a00;font-weight: 500;margin-left: 5px;"></h2>
                        <br><br>
                        ...
                        <h2>合作者4：</h2>
                        <br><br>
                        <h1>学号</h1><input type="text" class="author_num" id="author5_num" name="author5_id" placeholder="请输入合作者4学号"><h2 id="author5_num_check" style="color: #ff6a00;font-weight: 500;margin-left: 5px;"></h2>
                        <br><br>
                        ...
                        <h2>合作者5：</h2>
                        <br><br>
                        <h1>学号</h1><input type="text" class="author_num" id="author6_num" name="author6_id" placeholder="请输入合作者5学号"><h2 id="author6_num_check" style="color: #ff6a00;font-weight: 500;margin-left: 5px;"></h2>
                        <br><br>
                        ...
                        <h2>指导教师：</h2>
                        <br>
                        <h1>姓名</h1><input type="text" class="teacher_name" id="teacher_name" name="teacher_name"> 
                        <h1>性别</h1>
                            <select class="teacher_gender" id="teacher_gender">
                                <option value="M">男</option>
                                <option value="F">女</option>
                            </select>
                        <h1>年龄</h1><input type="text" class="teacher_age" id="teacher_age" name="teacher_age">
                        <br><br>
                        <h1>工作单位</h1><input type="text" class="teacher_job" id="teacher_job" name="teacher_job">
                        <br><br>
                        <h1>通讯地址</h1><input type="text" class="teacher_add" id="teacher_add" name="teacher_add">
                        <br><br>
                        <h1>邮政编码</h1><input type="text" class="teacher_zipcode" id="teacher_zipcode" name="teacher_zipcode">
                        <br><br>
                        <h1>单位电话</h1><input type="text" class="teacher_workphone" id="teacher_workphone" name="teacher_workphone">
                        <h1>住宅电话</h1><input type="text" class="teacher_homephone" id="teacher_homephone" name="teacher_homephone">
                        <br><br>
            ...
            <div id="step3" style="display: none">                
               <div id="B1_form">
                   ...
                   <hr/> 
                   <br>
                   <h1>作品撰写的目的和基本思路:</h1><br><br><textarea class="B1_form" id="B1_form_2" name="b1_1"></textarea>
                   <br><br>
                   <hr/> 
                   <br>
                   <h1>作品的科学性、先进性及独特之处:</h1><br><br><textarea class="B1_form" id="B1_form_3" name="b1_2"></textarea>
                   <br><br>
                   <hr/> 
                   <br>
                   <h1>作品的实际应用价值和现实意义:</h1><br><br><textarea class="B1_form" id="B1_form_4" name="b1_3"></textarea>
                   <br><br>
                   <hr/> 
                   <br>
                   <h1>学术论文文摘:</h1><br><br><textarea class="B1_form" id="B1_form_5" name="b1_4"></textarea>
                   <br><br>
                   <hr/> 
                   <br>
                   <h1>作品在何时、何地、何种机构举行的会议上或报刊上发表及所获奖励:</h1><br><br><textarea class="B1_form" id="B1_form_6" name="b1_5"></textarea>
                   <br><br>
                   <hr/> 
                   <br>
                   <h1>鉴定结果:</h1><br><br><textarea class="B1_form" id="B1_form_7" name="b1_6"></textarea>
                   <br><br>
                   <hr/> 
                   <br>
                   <h1>请提供对于理解、审查、评价所申报作品具有参考价值的现有技术及技术文献的检索目录:</h1><br><br><textarea class="B1_form" id="B1_form_8" name="b1_7"></textarea>
                   <br><br>
                   <hr/> 
                   <br>
                   <h1>申报材料清单（申报论文一篇，相关资料名称及数量）:</h1><br><br><textarea class="B1_form" id="B1_form_9" name="b1_8"></textarea>
                   <br><br>
                   <hr/> 
                   <br>
                   <h1>当前国内外同类课题研究水平概述:</h1><br><br><textarea class="B1_form" id="B1_form_10" name="b1_9"></textarea>
                   <br><br>
               ...
               <div id="B2_form">
                   ...
                   <hr/> 
                   <br>
                   <h1>作品撰写的目的和基本思路:</h1><br><br><textarea class="B2_form" id="B2_form_3" name="b2_1"></textarea>
                   <br><br>
                   <hr/> 
                   <br>
                   <h1>作品的科学性、先进性及独特之处:</h1><br><br><textarea class="B2_form" id="B2_form_4" name="b2_2"></textarea>
                   <br><br>
                   <hr/> 
                   <br>
                   <h1>作品的实际应用价值和现实指导意义:</h1><br><br><textarea class="B2_form" id="B2_form_5" name="b2_3"></textarea>
                   <br><br>
                   <hr/> 
                   <br>
                   <h1>作品摘要:</h1><br><br><textarea class="B2_form" id="B2_form_6" name="b2_4"></textarea>
                   <br><br>
                   <hr/> 
                   <br>
                   <h1>作品在何时、何地、何种机构举行的会议或报刊上发表登载、所获奖励及评定结果:</h1><br><br><textarea class="B2_form" id="B2_form_7" name="b2_5"></textarea>
                   <br><br>
                   <hr/> 
                   <br>
                   <h1>请提供对于理解、审查、评价所申报作品，具有参考价值的现有对比数据及作品中资料来源的检索目录:</h1><br><br><textarea class="B2_form" id="B2_form_8" name="b2_6"></textarea>
                   <br><br>
                   <hr/> 
                   <br>
                   <h1>调查方式:</h1><br><br>
                        <input type="checkbox" class="B2_type_check" id="B2_type_check1" name="b2_c_1"><h2>走访</h2>
                        <input type="checkbox" class="B2_type_check" id="B2_type_check2" name="b2_c_2"><h2>问卷</h2>
                        <input type="checkbox" class="B2_type_check" id="B2_type_check3" name="b2_c_3"><h2>现场采访</h2>
                        <input type="checkbox" class="B2_type_check" id="B2_type_check4" name="b2_c_4"><h2>人员介绍</h2>
                        <input type="checkbox" class="B2_type_check" id="B2_type_check5" name="b2_c_5"><h2>个别交谈</h2>
                        <input type="checkbox" class="B2_type_check" id="B2_type_check6" name="b2_c_6"><h2>亲临实践</h2>
                        <input type="checkbox" class="B2_type_check" id="B2_type_check7" name="b2_c_7"><h2>会议</h2>
                        <input type="checkbox" class="B2_type_check" id="B2_type_check8" name="b2_c_8"><h2>图片、照片</h2><br>
                        <input type="checkbox" class="B2_type_check" id="B2_type_check9" name="b2_c_9"><h2>书报刊物</h2>
                        <input type="checkbox" class="B2_type_check" id="B2_type_check10" name="b2_c_10"><h2>统计报表</h2>
                        <input type="checkbox" class="B2_type_check" id="B2_type_check11" name="b2_c_11"><h2>影视资料</h2>
                        <input type="checkbox" class="B2_type_check" id="B2_type_check12" name="b2_c_12"><h2>文件</h2>
                        <input type="checkbox" class="B2_type_check" id="B2_type_check13" name="b2_c_13"><h2>集体组织</h2>
                        <input type="checkbox" class="B2_type_check" id="B2_type_check14" name="b2_c_14"><h2>自发</h2>
                        <input type="checkbox" class="B2_type_check" id="B2_type_check15" name="b2_c_15"><h2>其它</h2>
                   <br><br>
                   <hr/> 
                   <br>
                   <h1>主要调查单位及调查数量:</h1><br><h1>按照以下格式：______省(市)_______县（区）_______乡（镇）________村（街）单位_______________邮编_________姓名_____电话_______调查单位_________个_______人次</h1><br><br><textarea class="B2_form" id="B2_form_10" name="b2_7"></textarea>
                   <br><br>
                   <hr/> 
                   <br>
                   <h1>当前国内外同类课题研究水平概述:</h1><br><br><textarea class="B2_form" id="B2_form_11" name="b2_8"></textarea>
                   <br><br>
                   <input type="button" value="上一步" class="pre_button2" onclick="ShowStep2()">
                   <input type="button" value="保存" class="save_button">
                   <input type="button" value="提交" class="next_button2">                        
               ...
               <div id="B3_form">
                   ...
                   <hr/>
                   <br>
                   <h1>作品设计、发明的目的和基本思路，创新点，技术关键和主要技术指标:</h1><br><br><textarea class="B3_form" id="B3_form_3" name="b3_1"></textarea>
                   <br><br>
                   <hr/>
                   <br>
                   <h1>作品的科学性先进性（必须说明与现有技术相比、该作品是否具有突出的实质性技术特点和显著进步。请提供技术性分析说明和参考文献资料）:</h1><br><br><textarea class="B3_form" id="B3_form_4" name="b3_2"></textarea>
                   <br><br>
                   <hr/>
                   <br>
                   <h1>作品在何时、何地、何种机构举行的评审、鉴定、评比、展示等活动中获奖及鉴定结果:</h1><br><br><textarea class="B3_form" id="B3_form_5" name="b3_3"></textarea>
                   <br><br>
                   <hr/>
                   <br>
                   <h1>作品所处阶段</h1>
                   ...
                   <br><br><hr/>
                   <br>
                   <h1>技术转让方式</h1><br><br><textarea class="B3_form" id="B3_form_7" name="b3_5"></textarea>
                   <br><br>
                   <hr/>
                   <br>
                   <h1>作品可展示的形式:</h1><br><br>
                        <input type="checkbox" class="B3_type_check" id="B3_type_check1" name="b3_c_1"><h2>实物、产品</h2>
                        <input type="checkbox" class="B3_type_check" id="B3_type_check2" name="b3_c_2"><h2>模型</h2>
                        <input type="checkbox" class="B3_type_check" id="B3_type_check3" name="b3_c_3"><h2>图纸</h2>
                        <input type="checkbox" class="B3_type_check" id="B3_type_check4" name="b3_c_4"><h2>磁盘</h2>
                        <input type="checkbox" class="B3_type_check" id="B3_type_check5" name="b3_c_5"><h2>现场演示</h2>
                        <input type="checkbox" class="B3_type_check" id="B3_type_check6" name="b3_c_6"><h2>图片</h2>
                        <input type="checkbox" class="B3_type_check" id="B3_type_check7" name="b3_c_7"><h2>录像</h2>
                        <input type="checkbox" class="B3_type_check" id="B3_type_check8" name="b3_c_8"><h2>样品</h2><br>
                   <br><br>
                   <hr/>
                   <br>
                   <h1>使用说明及该作品的技术特点和优势，提供该作品的适应范围及推广前景的技术性说明及市场分析和经济效益预测:</h1><br><br><textarea class="B3_form" id="B3_form_8" name="b3_6"></textarea>
                   <br><br>
                   <hr/>
                   <h1>专利申报情况:</h1>
                   <br>
                   <input type="checkbox" class="B3_type_check" id="B3_type_check9" name="b3_7"><h1>提出专利申报；</h1><h1>申报号：</h1><input type="text" class="p_num1" id="ip1"><h1>申报日期：</h1><input type="text" class="p_day1" id="ip1_date"placeholder="格式如：2014-06-05">
                   <br> 
                   ...
                   <hr/> 
                   <br>
                   <h1>当前国内外同类课题研究水平概述:</h1><br><br><textarea class="B3_form" id="B3_form_9" name="b3_8"></textarea>
                   <br><br>
                   <input type="button" value="上一步" class="pre_button2" onclick="ShowStep2()">
                   <input type="button" value="保存" class="save_button">
                   <input type="button" value="提交" class="next_button2">
