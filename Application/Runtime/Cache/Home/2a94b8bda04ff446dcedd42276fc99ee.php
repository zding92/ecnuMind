...
<head>
	...
	<link href="/Eclipse_For_PHP/ecnu_mind/Public/css/IndexRoll.css" rel="stylesheet">
	<link href="/Eclipse_For_PHP/ecnu_mind/Public/css/jquery-ui.css" rel="stylesheet">
    <link rel="Stylesheet" type="text/css" href="/Eclipse_For_PHP/ecnu_mind/Public/css/HomePages.css" /> 
    <link rel="Stylesheet" type="text/css" href="/Eclipse_For_PHP/ecnu_mind/Public/css/IndexSection2.css" /> 
    <script src="/Eclipse_For_PHP/ecnu_mind/Public/jsLib/jquery/jquery.js"></script>
    ...
    <script src="/Eclipse_For_PHP/ecnu_mind/Public/js/index/HomeScript.js"></script>
	<!--[if lte IE 8]>
	<style type="text/css">
...
<body>
	<section class="section-wrap">
		<div class="section section-1">
			...
			<img src="/Eclipse_For_PHP/ecnu_mind/Public/img/back_large.jpg" style="width: auto;height: auto" alt="图片载入失败">
			</div> 
		...
		<div class="section section-2">
			<div class="section2">
				...
				<div class="shake"> <img alt="寻找项目的伙伴" src="/Eclipse_For_PHP/ecnu_mind/Public/img/Index/shake.jpg"></div>
			</div>
		</div>
		<div class="section section-3">
			<div class="section3" style="background:url(/Eclipse_For_PHP/ecnu_mind/Public/img/Index/opportunity.jpg); width:100%; height:100%">
		...
		<div class="section section-4">
			<div class="section4" style="background:url(/Eclipse_For_PHP/ecnu_mind/Public/img/Index/coworker.jpg); width:100%; height:100%">
    ...
    <script> 
    	var login_url = '/Eclipse_For_PHP/ecnu_mind/index.php/Home/Index/login'; 
    	var register_url = '/Eclipse_For_PHP/ecnu_mind/index.php/Home/Index/registerCustom'
    	var public_url = '/Eclipse_For_PHP/ecnu_mind/Public';
  		var custom_url = '/Eclipse_For_PHP/ecnu_mind/index.php/custom/home/home';
  		var admin_url = '/Eclipse_For_PHP/ecnu_mind/index.php/Admin/home/home';
  		var incomplete_url = '/Eclipse_For_PHP/ecnu_mind/index.php/custom/guide/guide';
    </script>
	<script src="/Eclipse_For_PHP/ecnu_mind/Public/js/index/Login.js"></script>
	<script src="/Eclipse_For_PHP/ecnu_mind/Public/js/index/Register.js"></script>
	<!-- <script src="http://libs.baidu.com/jquery/2.0.0/jquery.min.js"></script>-->
	<script src="/Eclipse_For_PHP/ecnu_mind/Public/jsLib/jquery/jquery.min.js"></script>
	<script src="/Eclipse_For_PHP/ecnu_mind/Public/js/index/IndexRoll.js"></script> <!-- 整体网页的上下滑动翻转，包括立即体验点击返回顶部 -->
