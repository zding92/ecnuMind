		    ...
		    <div class="Part_inner clearfix">
		       <div class="nav">
		           ...
		           <div class="comp_child nav_child">
		             ...
		             <a href="#my_comp" id="my_comp" class="clickble"><div class="icon"><img src="/webprj/ecnu_mind/Public/img/icon/safe.png" alt="error"></div>我的竞赛</a>
		           </div>
		           
		           <a href="#projects" id="btn_pro" class="clickble"><div class="icon"><img src="/webprj/ecnu_mind/Public/img/icon/prjinfo.png" alt="error"></div>项目信息</a>
