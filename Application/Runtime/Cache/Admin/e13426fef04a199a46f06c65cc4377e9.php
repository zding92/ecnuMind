...
<head>
  ...
  <script>
  	var getDataURL = '/Eclipse_For_PHP/ecnu_mind/index.php/Home/Comp/getCompItem';
  </script>
...
<body style="background-color: #fff">
  ...
  <div style="margin:10px 15px 15px;">
    ...
    <table id="comp-table" 
           data-url="/Eclipse_For_PHP/ecnu_mind/index.php/Admin/CompControl/getCompInfo"
  ...
  <script src="/Eclipse_For_PHP/ecnu_mind/Public/js/Comp/Comp.js"></script>
</body>
