...
<html lang="en">
    <head>
		...
		<script type="text/javascript">
        	...
        	var model_url = "/Eclipse_For_PHP/ecnu_mind/index.php/Admin/Home";
    ...
    <body>
	    <div class="Part">
			    ...
			    <ul>
				    ...
				    <li id="right-li">
					    <ul id="sub-right-ul">
						    ...
						    <li id="exit-icon">
						    	<a href="/Eclipse_For_PHP/ecnu_mind/index.php/Home/Index/logout"><img alt="Exit" src="/Eclipse_For_PHP/ecnu_mind/Public/img/icon/exit.png" title="退出登录"></a>
						    </li>
					    </ul>
				    </li>
			    </ul>
		    ...
		    <div class="Part_inner clearfix">
		       <div class="nav">
		           <p>功能列表</p>
		           <a href="#HistoryItem" id="btn_history" class="clickble"><div class="icon"><img src="/Eclipse_For_PHP/ecnu_mind/Public/img/icon/home.png" alt="error"></div>历史项目</a>		           		           		           
		           <a href="#CurrentComp" id="btn_CurrentComp" class="clickble"><div class="icon"><img src="/Eclipse_For_PHP/ecnu_mind/Public/img/icon/ability.png" alt="error"></div>当前比赛</a>          
		           <a href="#CompControl" id="btn_CompControl" class="clickble"><div class="icon"><img src="/Eclipse_For_PHP/ecnu_mind/Public/img/icon/prjinfo.png" alt="error"></div>比赛管理</a>
		           <a href="#UserControl" id="btn_UserControl" class="clickble"><div class="icon"><img src="/Eclipse_For_PHP/ecnu_mind/Public/img/icon/find.png" alt="error"></div>用户管理</a>
		           <a href="#ChangePassWord" id="btn_ChangePassword" class="clickble"><div class="icon"><img src="/Eclipse_For_PHP/ecnu_mind/Public/img/icon/help.png" alt="error"></div>安全设置</a>
		       </div>
	    ...
	    <script src="/Eclipse_For_PHP/ecnu_mind/Public/js/Admin/Admin.js"></script>
    </body>
