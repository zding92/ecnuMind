...
<title>Safe</title>
  ...
  <link rel="Stylesheet" type="text/css" href="/Eclipse_For_PHP/ecnu_mind/Public/css/Safe.css" />
...
<body >
	<div class="title_box">
		<div style="display:inline-block;width: 15px;height: 15px;margin:0px 10px auto;">
			<img style="width: 15px;height: 15px; margin-left: -10px;align-items: center;margin-bottom: 5px;" src="/Eclipse_For_PHP/ecnu_mind/Public/img/icon/safe.png">
		</div>
		更改密码
	</div>
...
<script>
	var PasswordChange_url = '/Eclipse_For_PHP/ecnu_mind/index.php/Custom/Home/PasswordChange'; 
</script>
<script src="/Eclipse_For_PHP/ecnu_mind/Public/js/home/ChangePassword.js"></script>
</body>
</html>